#!/usr/bin/env python3
"""
1688-source-suppliers —— 1688找供应商 CLI 统一入口
...
Commands（更多参数见项目根目录 SKILL.md）:
    ali_1688_source_suppliers  找供应商请求    python3 cli.py ali_1688_source_suppliers --query "供应商名称"
...
def _usage(commands: dict):
    lines = ["**1688-source-suppliers 用法**\n", "```"]
